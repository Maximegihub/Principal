...
<img id="rcb-ad-block-checker" src="%s" style="display:none;">
<script>(function(img, notice) {
    img.addEventListener("error", function() {
        notice.classList.remove("hidden");
    });
})(document.getElementById("rcb-ad-block-checker"), document.getElementById("rcb-ad-block-checker-notice"))</script>',
            __(
                '<strong>Adblocker detected</strong>: You are using an adblocker for this website. This can block parts of the Real Cookie Banner settings and thus lead to errors. <strong>Please deactivate your adblocker for your own website!</strong>',
                RCB_TD
            ),
