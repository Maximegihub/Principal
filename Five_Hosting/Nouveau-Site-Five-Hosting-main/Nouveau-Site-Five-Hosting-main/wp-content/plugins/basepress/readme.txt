...
Tags: knowledge base, documentation, wiki, documents, docs, knowledgebase, knowledge management, table of content, faq, customer support, knowledge, TOC, doc page, best
...
Powerful Knowledge Base and Wiki plugin for WordPress. Easily create & manage documentation to reduce support tickets and scale your customer support operations. Works with any theme.
...
[BasePress](https://codesavory.com/) allows you to organise documentation for clients and employees. Build as many independent knowledge bases as you need to document your products or services out of the box.

It is straightforward to use, thanks to its clear and simple administration tools that integrates seamlessly in the WordPress admin area.
...
Check detailed [BasePress Documentation](https://codesavory.com/knowledge-base/basepress/).
...
-  Serves targeted answer to your customers, saving them time.
...
See our [knowledge base & live demo](https://codesavory.com/knowledge-base/basepress/ "Knowledge Base documentation")

## WHAT CAN YOU USE BASEPRESS FOR

- Runbooks
- Internal knowledgebase for employees on a intranet
...
Want to unlock the advanced features? [Upgrade to our Pro version](https://codesavory.com/get-basepress/)


## Support & Product Documentation ##

- For detailed plugin documentation visit our [knowledge base](https://codesavory.com/knowledge-base/basepress/)
- If you have any more questions, visit our support on the Plugin’s Forum
- For more information about premium version, features etc. visit our website at [codeSavory](https://codesavory.com/)
