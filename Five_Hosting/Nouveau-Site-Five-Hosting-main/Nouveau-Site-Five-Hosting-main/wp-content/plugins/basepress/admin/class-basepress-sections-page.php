...
if ( ! class_exists( 'Basepress_Sections_Page' ) ) {
	...
	class Basepress_Sections_Page {
		...
		public function add_sections_page() {
			...
			add_submenu_page( 'edit.php?post_type=knowledgebase', 'BasePress ' . __( 'Sections', 'basepress' ), __( 'Sections', 'basepress' ), 'manage_categories', 'basepress_sections', array( $this, 'display_screen' ), 3 );
		}
							...
							<div class="form-wrap">
								...
								<form id="new-basepress-section">
									...
									<div class="form-field term-slug-wrap">
										<label for="section-slug"><?php echo __( 'Slug', 'basepress' ); ?></label>
				...
				<div id="edit-section-wrap">
					<form id="edit-basepress-section">
						...
						<div id="default-category-edit">
							<a href="#" target="_blank"><?php echo __( 'View More', 'basepress' ); ?></a>
						</div>
		...
		public function get_section_row( $section ) {
			...
			<li class="section-row" data-section="<?php echo $section->term_id; ?>" data-name="<?php echo $section->name; ?>" data-pos="<?php echo $pos; ?>">
				...
				<div class="section-description"><div><?php echo $description; ?></div></div>
		...
		*/
		...
		public function basepress_get_section_list() {
			...
			if( ! empty( $section_terms ) ){
				...
				echo '<li class="section-row notice">' . $notice . '</li>';
			}
		...
		public function basepress_get_section_data() {
			...
			//Return section data
			header( 'Content-type: application/json' );
			echo json_encode( array( 'section' => $section_data, 'parents' => $parents ) );
