...
if ( ! class_exists( 'Basepress_Products_Page' ) ) {
	...
	class Basepress_Products_Page {
		...
		public function add_products_page() {
			...
			add_submenu_page( 'edit.php?post_type=knowledgebase', 'BasePress' . __( 'Manage KBs', 'basepress' ), __( 'Manage KBs', 'basepress' ), 'manage_categories', 'basepress_manage_kbs', array( $this, 'display_screen' ), 2 );
		}
							...
							<div class="form-wrap">
								...
								<form id="new-basepress-product">
									...
									<div class="form-field term-slug-wrap">
										<label for="product-slug"><?php echo __( 'Slug', 'basepress' ); ?></label>
		...
		public function get_product_row( $product ) {
			...
			<li class="product-row<?php echo $row_class; ?>" data-product="<?php echo $product->term_id; ?>" data-productname="<?php echo $product->name; ?>" data-pos="<?php echo $pos; ?>">
				...
				<div class="product-description"><div><?php echo $description; ?></div></div>
		...
		public function basepress_new_product() {
			...
			$product_image = array(
				'image_url'    => $form['product-image-url'] ? $form['product-image-url'] : $default_image,
				'image_width'  => $form['product-image-url'] ? $form['product-image-width'] : 400,
				'image_height' => $form['product-image-url'] ? $form['product-image-height'] : 400,
			);
			//Add product image
			update_term_meta(
				$term['term_id'],
