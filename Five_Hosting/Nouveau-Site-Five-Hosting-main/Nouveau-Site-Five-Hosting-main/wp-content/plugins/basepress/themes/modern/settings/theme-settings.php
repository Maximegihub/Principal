...
class Basepress_Modern_Theme_Settings
{
    ...
    public function display_screen()
    {
		...
		<div class="wrap">
			<h1><?php 
        _e( 'Modern Theme Settings', 'basepress' );
        ?></h1>
			<div class="bpmt-body">
        ...
        _e( 'Enable Settings', 'basepress' );
        ?></div>
						<input id="save-settings" type="submit" value="<?php 
        _e( 'Save Settings', 'basepress' );
        ?>">
					</div>
        ...
        _e( 'Google Font @import', 'basepress' );
        ?></th>
									<td class="setting-control">
										<input type="text" value="<?php 
        echo  stripslashes( $settings['font_family'] ) ;
        ...
        ?></p>
								...
								<tr>
									<th class="setting-title"><?php 
        _e( 'Header Title', 'basepress' );
        ?></th>
									<td class="setting-control">
										<input type="text" value="<?php 
        echo  stripslashes( $settings['header_title'] ) ;
        ?>" name="header_title" size="100">
										<p class="description"><?php 
        _e( 'Default is <b>Knowledge Base</b>.', 'basepress' );
        ?></p>
									</td>
								</tr>
								...
								<tr>
									<th class="setting-title"><?php 
        _e( 'Force Full Width Header', 'basepress' );
        ?></th>
									<td class="setting-control">
        ...
        ?></p>
								...
								<tr>
									<th class="setting-title"><?php 
        _e( 'Header top offset', 'basepress' );
        ?></th>
									<td class="setting-control">
										<input type="text" value="<?php 
        echo  $settings['header_offset'] ;
        ?>" name="header_offset">
										<p class="description"><?php 
        ...
        ?></p>
								...
								<tr>
									<th class="setting-title"><?php 
        _e( 'Header Background Image', 'basepress' );
        ?></th>
									<td class="setting-control">
										<input type="text" value="<?php 
        ...
        ?></button>
								...
								<tr>
									<th class="setting-title"><?php 
        _e( 'Make Sidebar Sticky', 'basepress' );
        ?></th>
									<td class="setting-control">
        ...
        ?>>
										<p class="description"><?php 
        _e( 'If activated the sidebar will remain fixed in the page while scrolling.', 'basepress' );
        ?></p>
									</td>
								</tr>
        ...
        ?>
								...
								<tr>
									<th class="setting-title"><?php 
        _e( 'Sticky Elements Threshold', 'basepress' );
        ?></th>
									<td class="setting-control">
										<input type="text" value="<?php 
        echo  $settings['sidebar_threshold'] ;
        ?>" name="sidebar_threshold">
										<p class="description"><?php 
        _e( 'Distance from top of screen including unit( px, %, em etc.) before sidebar becomes sticky.', 'basepress' );
        ?></p>
									</td>
								</tr>
								...
								<tr>
									<th class="setting-title"><?php 
        _e( 'Enable Custom Colors', 'basepress' );
        ?></th>
									<td class="setting-control">
        ...
        ?>>
										<p class="description"><?php 
        _e( 'Enable this to apply the custom colors below.', 'basepress' );
        ?></p>
									</td>
								</tr>
								...
								<tr>
									<th class="setting-title"><?php 
        _e( 'Header Background Color', 'basepress' );
        ?></th>
									<td class="setting-control">
										<input name="header_color" type="text" value="<?php 
        echo  $settings['header_color'] ;
        ?>" class="bp-color-field" data-default-color="#34424c" />
								...
								<tr>
									<th class="setting-title"><?php 
        _e( 'Header Text Color', 'basepress' );
        ?></th>
									<td class="setting-control">
										<input name="header_text_color" type="text" value="<?php 
        echo  $settings['header_text_color'] ;
        ?>" class="bp-color-field" data-default-color="#ffffff" />
								...
								<tr>
									<th class="setting-title"><?php 
        _e( 'Accent Color', 'basepress' );
        ?></th>
									<td class="setting-control">
										<input name="accent_color" type="text" value="<?php 
        echo  $settings['accent_color'] ;
        ?>" class="bp-color-field" data-default-color="#17aacf" />
								...
								<tr>
									<th class="setting-title"><?php 
        _e( 'Buttons Text Color', 'basepress' );
        ?></th>
									<td class="setting-control">
										<input name="buttons_text_color" type="text" value="<?php 
        echo  $settings['buttons_text_color'] ;
        ?>" class="bp-color-field" data-default-color="#ffffff" />
									</td>
								</tr>
