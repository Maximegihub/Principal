 ...
 * Replaces comments classes to avoid interference with main theme styles
 *
 * The use of this class has been discontinued since 2.12.0 as not necessary
 *
 * @since 1.3.0
 */
...
class BasePress_Walker_Comment extends Walker {
	...
	protected function comment( $comment, $depth, $args ) {
		...
		<?php if ( '0' == $comment->comment_approved ) : ?>
			<em class="bpress-comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.' ); ?></em>
			<br />
		<?php endif; ?>
	...
	protected function html5_comment( $comment, $depth, $args ) {
		...
		<article id="div-comment-<?php comment_ID(); ?>" class="bpress-comment-body">
			<footer class="bpress-comment-meta">
				...
				<?php if ( '0' == $comment->comment_approved ) : ?>
					<p class="bpress-comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.' ); ?></p>
				<?php endif; ?>
			</footer><!-- .comment-meta -->
