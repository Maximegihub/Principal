    ...
    class Basepress_CPT
    {
        ...
        public function register_post_type()
        {
            ...
            register_post_type( 'knowledgebase', array(
                ...
                'add_new'       => __( 'Add New Article', 'basepress' ),
            ),
        ...
        public function get_bulk_edit_sections_list()
        {
            ...
            $extra_options = "\n\t<option disabled selected>" . __( '&mdash; No Change &mdash;' ) . '</option><option disabled>─────────</option>';
            $extra_options .= '<option value="none">' . __( 'None', 'basepress' ) . '</option>';
